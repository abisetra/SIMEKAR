            ...
            <div class="col-12">
                <div class="card card-outline card-primary shadow">
                    <div class="card-header">
                        <h3 class="card-title" style="font-size: 28px">Teguran</h3>

                        <span class="float-right mt-1 mr-2">
                            @can('admin')
                            <a href="{{ route('teguran.tambah') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" type="button"><i class="fas fa-plus"></i> Tambah Data</a>
                            @endcan
                            @can('hrd')
                            <a href="{{ route('teguran.tambah') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" type="button"><i class="fas fa-plus"></i> Tambah Data</a>
                            @endcan
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <livewire:teguran-export-excel />
                                    <livewire:teguran-export-pdf />
                                </div>
                            </div>
                        </span>
                    </div>
                    <div class="card-body">
                        <livewire:teguran-table />
                    </div>
                </div>
            </div>
        </div>
